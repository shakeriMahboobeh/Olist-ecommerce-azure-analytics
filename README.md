...
![Synapse Studio Git Configuration](docs/screenshots/git_integration.png)

## 📊 Dashboard

### Olist Sales Overview

![Olist Sales Overview](docs/screenshots/olist_sales_overview.png)
...
![Synapse Pipeline Canvas](docs/screenshots/pipeline.png)
